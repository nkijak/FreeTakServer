...
class OrchestratorConstants:
    def __init__(self):
        ...
        self.COTIPDESC = (
            "the IP you would like FreeTAKServer to run receive connections on"
        )
        self.SSLCOTPORTDESC = (
            "the port you would like FreeTAKServer to run receive SSL connections on"
        )
        self.SSLCOTIPDESC = (
            "the IP you would like FreeTAKServer to run receive SSL connections on"
        )
