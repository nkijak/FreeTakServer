...
class BasicModelInstantiate:
    ...
    def precisionlocationAtrib(self):
        try:
            self.modelObject.detail.precisionlocation.altsrc = (
                self.precisionlocation.attrib["altsrc"]
            )
        except:
            pass
        try:
            self.modelObject.detail.precisionlocation.geopointsrc = (
                self.precisionlocation.attrib["geopointsrc"]
            )
        except:
            pass
