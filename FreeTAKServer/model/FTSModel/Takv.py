...
class Takv(FTSProtocolObject):
    ...
    @staticmethod
    def connection(
        VERSION=vars.connection().VERSION,
        PLATFORM=vars.connection().PLATFORM,
        DEVICE=vars.connection().DEVICE,
        OS=vars.connection().OS,
    ):
    ...
    @staticmethod
    def UserUpdate(
        DEVICE=vars.UserUpdate().device,
        PLATFORM=vars.UserUpdate().platform,
        OS=vars.UserUpdate().os,
