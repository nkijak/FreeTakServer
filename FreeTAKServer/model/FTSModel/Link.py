...
class Link(FTSProtocolObject):
    ...
    def VideoStream(
        ...
        PRODUCTIONTIME=vars.VideoStream().PRODUCTIONTIME,
        RELATIONSHIP=vars.VideoStream().RELATIONSHIP,
        PARENTCALLSIGN=vars.VideoStream().PARENTCALLSIGN,
    ):
        link = Link()
        link.setuid(UID)
    ...
    def drop_point(
        ...
        RELATION=vars.drop_point().RELATION,
        PRODUCTIONTIME=vars.drop_point().PRODUCTIONTIME,
        TYPE=vars.drop_point().TYPE,
        PARENTCALLSIGN=vars.drop_point().PARENTCALLSIGN,
    ):
        link = Link()
        link.setuid(UID)
    ...
    def geochat(
        ...
        RELATION=vars.geochat().RELATION,
        PRODUCTIONTIME=vars.geochat().PRODUCTIONTIME,
    ...
    def emergency_on(
        ...
        RELATION=vars.emergency_on().RELATION,
        PRODUCTIONTIME=vars.emergency_on().PRODUCTIONTIME,
    ...
    def disconnect(
        ...
        RELATION=vars.disconnect().RELATION,
    ):
        link = Link()
        link.setuid(UID)
        link.settype(TYPE)
    ...
    def DeleteVideo(
        ...
        RELATION=vars.DeleteVideo().RELATION,
    ):
        link = Link()
        link.setuid(UID)
        link.settype(TYPE)
    ...
    def Route(
        ...
        RELATION=vars.Route().RELATION,
        POINT=vars.Route().POINT,
        CALLSIGN=vars.Route().CALLSIGN,
        REMARKS=vars.Route().REMARKS,
    ):
        link = Link()
        link.setuid(UID)
        link.settype(TYPE)
    ...
    def SPISensor(
        ...
        RELATION=vars.SPISensor().RELATION,
    ):
        link = Link()
        link.setuid(UID)
        link.settype(TYPE)
    ...
    def BitsImageryVideo(
        ...
        PRODUCTIONTIME=vars.BitsImageryVideo().PRODUCTIONTIME,
    ):
        link = Link()
        link.setuid(UID)
        link.setproduction_time(PRODUCTIONTIME)
