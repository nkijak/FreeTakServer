...
#
#######################################################
from FreeTAKServer.model.FTSModelVariables.PrecisionlocationVariables import (
    PrecisionlocationVariables as vars,
)
...
class Precisionlocation(FTSProtocolObject):
    ...
    @staticmethod
    def connection(
        ALTSRC=vars.connection().ALTSRC, GEOPOINTSRC=vars.connection().GEOPOINTSRC
    ):
        precisionlocation = Precisionlocation()
        precisionlocation.setaltsrc(altsrc=ALTSRC)
    ...
    @staticmethod
    def UserUpdate(
        ALTSRC=vars.UserUpdate().altsrc, GEOPOINTSRC=vars.UserUpdate().geopointsrc
    ):
        precisionlocation = Precisionlocation()
