...
#
#######################################################
from FreeTAKServer.model.FTSModelVariables.EmergencyVariables import (
    EmergencyVariables as vars,
)
...
class Emergency(FTSProtocolObject):
    ...
    @staticmethod
    def emergency_on(
        INTAG=vars.emergency_on().INTAG,
        TYPE=vars.emergency_on().TYPE,
        ALERT=vars.emergency_on().ALERT,
        CANCEL=vars.emergency_on().CANCEL,
    ):
        emergency = Emergency()
    ...
    @staticmethod
    def emergency_off(
        CANCEL=vars.emergency_off().CANCEL, INTAG=vars.emergency_off().INTAG
    ):
        emergency = Emergency()
        emergency.setcancel(CANCEL)
        emergency.setINTAG(INTAG)
