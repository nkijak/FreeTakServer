...
_TAKCONTROL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="minProtoVersion",
            full_name="TakControl.minProtoVersion",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="maxProtoVersion",
            full_name="TakControl.maxProtoVersion",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
TakControl = _reflection.GeneratedProtocolMessageType(
    "TakControl",
    (_message.Message,),
    {
